...
public class FPSRenderEventHandler extends Gui {
    ...
    public void onRenderGameOverlay(RenderGameOverlayEvent event) {
        ...
        int fpsCount = Minecraft.func_175610_ah();
        if (TbscFPS.pos == CounterPosition.TOP_LEFT) {
            this.func_73731_b(mc.field_71466_p, String.valueOf(fpsCount), xPosLeft, yPosTop, 0xff0000);
            return;
        }
        if (TbscFPS.pos == CounterPosition.TOP_MIDDLE) {
            this.func_73731_b(mc.field_71466_p, String.valueOf(fpsCount), xPosCenter, yPosTop, 0xff0000);
            return;
        }
        if (TbscFPS.pos == CounterPosition.TOP_RIGHT) {
            this.func_73731_b(mc.field_71466_p, String.valueOf(fpsCount), xPosRight, yPosTop, 0xff0000);
            return;
        }
        if (TbscFPS.pos == CounterPosition.CENTER_RIGHT) {
            this.func_73731_b(mc.field_71466_p, String.valueOf(fpsCount), xPosRight, yPosCenter, 0xff0000);
            return;
        }
        if (TbscFPS.pos == CounterPosition.BOTTOM_RIGHT) {
            this.func_73731_b(mc.field_71466_p, String.valueOf(fpsCount), xPosRight, yPosDown, 0xff0000);
            return;
        }
        if (TbscFPS.pos == CounterPosition.BOTTOM_MIDDLE) {
            this.func_73731_b(mc.field_71466_p, String.valueOf(fpsCount), xPosCenter, yPosDown, 0xff0000);
            return;
        }
        if (TbscFPS.pos == CounterPosition.BOTTOM_LEFT) {
            this.func_73731_b(mc.field_71466_p, String.valueOf(fpsCount), xPosLeft, yPosDown, 0xff0000);
            return;
        }
        if (TbscFPS.pos == CounterPosition.CENTER_LEFT) {
            this.func_73731_b(mc.field_71466_p, String.valueOf(fpsCount), xPosLeft, yPosCenter, 0xff0000);
            return;
        }
        this.func_73731_b(mc.field_71466_p, String.valueOf("?"), xPosLeft, yPosTop, 0xff0000);
    }
